...
const sections: NavSection[] = [
  {
    ...
    modules: [
      ...
      { id: 'm3', label: 'Central Limit Theorem' },
      { id: 'm4', label: 'Confidence Intervals' },
      { id: 'm5', label: 'Bayesian vs Frequentist' },
    ],
  },
  {
    id: 's2',
    ...
    modules: [
      { id: 'm6', label: 'Experiment Structure' },
      { id: 'm7', label: 'Metrics & Guardrails' },
      { id: 'm8', label: 'Metric Sensitivity Analysis' },
      { id: 'm9', label: 'Sample Size & Power' },
      { id: 'm10', label: 'Effect Size & MDE' },
      { id: 'm11', label: 'Variance Reduction (CUPED)' },
      { id: 'm12', label: 'Choosing the Right Test' },
      { id: 'm13', label: 'Switchback & Cluster Experiments' },
    ],
  },
  {
    id: 's3',
    ...
    modules: [
      { id: 'm14', label: 'A/A Testing' },
      { id: 'm15', label: 'Sequential Testing' },
      { id: 'm16', label: 'SRM Diagnostics' },
      { id: 'm17', label: 'Validity Threats' },
      { id: 'm18', label: 'Novelty & Time Effects' },
  ...
  },
  {
    ...
    modules: [
      { id: 'm20', label: 'Multiple Testing' },
      { id: 'm21', label: 'Bootstrap & Permutation Tests' },
      { id: 'm22', label: 'Lift Calculator' },
      { id: 'm23', label: 'Ratio Metrics & Delta Method' },
      { id: 'm24', label: 'Practical vs Statistical Significance' },
      { id: 'm25', label: 'Bayesian A/B Testing' },
      { id: 'm26', label: 'Multi-Armed Bandits' },
      { id: 'm27', label: 'Difference-in-Differences' },
    ],
  },
  {
    id: 's5',
    ...
    modules: [
      ...
      { id: 'm29', label: 'Heterogeneous Effects' },
      { id: 'm30', label: "Simpson's Paradox" },
      { id: 'm31', label: 'Regression to the Mean' },
    ],
  },
  {
    id: 's6',
    ...
    modules: [
      { id: 'm32', label: 'Bias-Variance Tradeoff' },
      { id: 'm33', label: 'Cross-Validation' },
      { id: 'm34', label: 'Model Metrics' },
      { id: 'm35', label: 'Calibration' },
      { id: 'm36', label: 'Cumulative Gains' },
      { id: 'm37', label: 'Feature Importance' },
      { id: 'm38', label: 'Model Drift & Monitoring' },
    ],
  },
];
