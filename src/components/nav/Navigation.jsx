    ...
    <nav className="flex flex-col h-full" aria-label="Module navigation">
      ...
      <div className="px-3 pb-3">
        <div className="relative">
          <svg width="14" height="14" viewBox="0 0 20 20" fill="none" className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[var(--svg-text-faint)]" aria-hidden="true">
      ...
      <div className="flex-1 overflow-y-auto sidebar-scroll px-3 pb-3">
            ...
            <div key={s.id} className="mb-5">
              <div className={
                ...
                {visited && sectionVisited > 0 && (
                  <span className="text-[9px] normal-case tracking-normal font-normal opacity-60">{sectionVisited}/{sectionTotal}</span>
                )}
              </div>
        ...
        {filteredSections.length === 0 && (
          <div className="text-[12px] text-[var(--svg-text-faint)] text-center py-4">No matches</div>
        )}
      </div>
      ...
      <div className="px-3 pb-4 pt-1 border-t border-[var(--color-border-subtle)]">
        ...
        <div className="hidden md:flex items-center justify-center gap-1.5 mt-2 text-[10px] text-[var(--svg-text-faint)]">
          ...
          <kbd className="bg-app-glass px-1.5 py-0.5 rounded ring-1 ring-[var(--color-border-subtle)]">↑</kbd>
          <kbd className="bg-app-glass px-1.5 py-0.5 rounded ring-1 ring-[var(--color-border-subtle)]">↓</kbd>
          <span>navigate</span>
        </div>
      </div>
