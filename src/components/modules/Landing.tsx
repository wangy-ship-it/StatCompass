...
const scenarios = [
  ...
  {
    title: 'Why our test showed no effect',
...
export default function Landing({
  ...
  return (
    <div>
      {/* Hero */}
      <div className="mb-10">
        <div className="text-[11px] text-[var(--color-accent-faint)] uppercase tracking-[0.15em] font-medium mb-2">
          StatCompass
        </div>
      ...
      <div className="mb-10">
        <div className="text-[10px] text-[var(--color-text-muted)] uppercase tracking-[0.15em] font-medium mb-4">
          Sections
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="flex-shrink-0 mt-0.5 opacity-60 group-hover:opacity-100 transition-opacity"
                  >
                    <path d={sectionIcons[s.id]} />
                  </svg>
                  <div className="min-w-0">
                    <div className="text-[14px] font-medium text-[var(--color-text-primary)] group-hover:text-[var(--color-accent)] transition-colors">
                      {s.title}
                    </div>
                    ...
                    <div className="text-[11px] text-[var(--svg-text-faint)] mt-1.5 opacity-60">
                      ...
                      {sVisited > 0 && (
                        <span className="text-[var(--color-accent-faint)]">
                          {' '}
                          · {sVisited} visited
                        </span>
                      )}
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {scenarios.map((sc, i) => (
            <div
              key={i}
              className="bg-app-surface rounded-xl p-4 ring-1 ring-[var(--color-border-subtle)]"
            >
